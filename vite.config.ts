...
// ! This config only works on local dev environment, on production (Vercel), we use the config in "vercel.json"
// Please make sure the configuration on two files are in sync
